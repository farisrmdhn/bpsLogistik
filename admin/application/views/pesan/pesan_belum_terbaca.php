      ...
      <ul class="list-group">
        <a href="<?php echo base_url();?>pesan_belum_terbaca">
          <li class="list-group-item d-flex justify-content-between align-items-center active">
            Pesan belum terbaca
            <span class="badge badge-danger badge-pill"><?php echo $jumlah_pesan;?></span>
          </li>
        </a>
      </ul>
    </div>
      ...
      <table class="table table-hover">
        <thead>
          <tr>
            ...
            <th scope="col" class="col-lg-4">Pesan</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary" style="margin-right: 0.5em" href="<?php echo base_url();?>baca/<?php echo $pesan['id'];?>">Baca</button>
            </td>
          </tr>
          <?php endforeach;?>
        </tbody>
